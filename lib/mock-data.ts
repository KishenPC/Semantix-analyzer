...
export const RECURSIVE_MOCK_ANALYSIS: AnalysisResult = {
  execution_trace: [
    ...
    { line: 4, variables: { n: 3 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)'] },
    { line: 5, variables: { n: 3 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)'] },
    { line: 8, variables: { n: 3 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)'] },
    { line: 4, variables: { n: 2 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)', 'factorial(2)'] },
    { line: 5, variables: { n: 2 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)', 'factorial(2)'] },
    { line: 8, variables: { n: 2 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)', 'factorial(2)'] },
    { line: 4, variables: { n: 1 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)', 'factorial(2)', 'factorial(1)'] },
    { line: 5, variables: { n: 1 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)', 'factorial(2)', 'factorial(1)'] },
    { line: 6, variables: { n: 1, return: 1 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)', 'factorial(2)', 'factorial(1)'] },
    { line: 8, variables: { n: 2, return: 2 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)', 'factorial(2)'] },
    { line: 8, variables: { n: 3, return: 6 }, callStack: ['main', 'factorial(5)', 'factorial(4)', 'factorial(3)'] },
    { line: 8, variables: { n: 4, return: 24 }, callStack: ['main', 'factorial(5)', 'factorial(4)'] },
  ...
  recursion_invariants: [
    {
      ...
      invariant: 'For any call factorial(k) where k > 1, the function returns k * factorial(k-1). The invariant holds that factorial(n) computes n! = n * (n-1) * ... * 1 for all non-negative integers n.',
    },
  ],
  time_complexity: {
    best: 'O(n)',
    average: 'O(n)',
    worst: 'O(n)',
    reasoning: 'The function makes exactly n recursive calls before reaching the base case. Each call performs constant-time work (comparison and multiplication), resulting in linear time complexity.',
  },
  space_complexity: 'O(n) stack space due to n recursive calls. Each call adds a new stack frame containing the parameter n and the return address. Maximum stack depth is n.',
}
